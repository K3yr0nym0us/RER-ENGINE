//! Tipos y utilidades compartidas de la UI HUD del jugador.

/// Rectángulo en NDC (centro + tamaño).
#[derive(Clone, Copy, Debug)]
pub struct UiHudRect {
    pub center_x: f32,
    pub center_y: f32,
    pub width: f32,
    pub height: f32,
...
impl PlayerUiImage {
    ...
    pub fn ui_hud_rect(&self) -> UiHudRect {
        UiHudRect {
            center_x: self.center_x,
            center_y: self.center_y,
            width: self.width,
...
pub fn source_aspect_from_ndc_rect(
    width_ndc: f32,
    height_ndc: f32,
    viewport_w: f32,
    viewport_h: f32,
...
pub fn default_image_width_ndc(source_aspect: f32) -> f32 {
    let _ = source_aspect;
    0.28_f32
}

pub fn default_button_size_ndc(shape_type: &str) -> (f32, f32) {
    match shape_type {
        "square" => (0.12, 0.12),
...
pub fn parse_hex_color_rgba(hex: &str, alpha_percent: f32) -> [f32; 4] {
...
pub fn box_corners(rect: UiHudRect) -> (f32, f32, f32, f32) {
...
pub const BOX_STACK_GAP: f32 = 0.11;

/// Esquinas para redimensionar elementos HUD.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PlayerUiResizeHandle {
    TopLeft,
    TopRight,
    BottomLeft,
    BottomRight,
...
pub fn apply_resize_locked_aspect(
    rect: &mut UiHudRect,
    start: UiHudRect,
