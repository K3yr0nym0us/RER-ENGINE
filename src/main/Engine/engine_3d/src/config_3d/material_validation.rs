...
use super::pbr_presets::{
    build_label_rgba, build_preset_albedo_rgba, surface_pbr_from_preset, PbrMaterialPreset,
    MAT_VAL_ROW_COUNT, MATERIAL_VALIDATION_ROWS,
};
...
pub fn spawn_material_comparison_scene(state: &mut State) {
    ...
    for i in 0..MAT_VAL_ROW_COUNT {
        ...
        state.world.insert(quad_id, crate::ecs::RenderLayer { value: 1 });
